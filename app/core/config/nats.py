...
async def start_consumers():
    ...
    try:
        ...
        sub1 = await js.subscribe(subject, stream=stream_name, durable="ai-service-onboarding-consumer", cb=onboarding_cb)
    ...
    try:
        ...
        sub2 = await js.subscribe(subject, stream=stream_name, durable="ai-service-budget-consumer", cb=budget_cb)
