...
완벽한 상품이 없을 수 있으므로, **주어진 후보 내에서 얼마나 최선의 선택을 했는지**를 기준으로 평가하세요.
...
### 1. 혜택 적합성 (0-40점)
제한된 상품 풀 내에서 유저 소비 패턴과 가장 잘 맞는 상품을 선택했는가
- 40점: 후보 내 최선의 선택, 소비 패턴과 연관성 있음
- 30점: 대체로 적합한 선택
- 20점: 일부 적합하나 더 나은 선택 가능
- 10점: 연관성 낮은 선택
- 0점: 명백히 잘못된 선택

### 2. 추천 사유 품질 (0-30점)
추천 사유에 유저의 실제 소비 데이터가 언급됐는가
- 30점: 모든 사유에 구체적 금액/카테고리 언급
- 20점: 절반 이상 구체적 언급
- 10점: 일부 언급
- 0점: 일반적 설명만
...
{{
  "score": 총점(0-100 정수),
  "breakdown": {{
    "relevance": 혜택적합성(0-40),
    "faithfulness": 추천사유품질(0-30),
    "eligibility": 자격조건(0-20),
    "diversity": 다양성(0-10)
  }},
  "comment": "총평 1문장"
}}"""
